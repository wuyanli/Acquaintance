...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func addToContext(name: String, photo: UIImage?,
    ...
    func deleteFromContext(person: PersonMO) { persistentContainer.viewContext.delete(person)
        print("deleting the person from context ...")
        saveContext() }
    func updateToContext(person: PersonMO, name: String,
                         photo: UIImage?,
                         notes: String?) { person.name = name
        if let photo = photo {
            person.photo = UIImagePNGRepresentation(photo) as NSData? }
        person.notes = notes
